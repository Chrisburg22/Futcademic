      ...
      <Card withBorder padding="lg" radius="md">
        <ScrollArea h={500}>
          <Stack>
            ...
            <Text size="sm">
              Al usar Futcademic aceptas estos términos y nuestra política de privacidad. Si no
              estás de acuerdo, no uses la plataforma.
            </Text>
            <Title order={4}>2. Uso de la plataforma</Title>
            <Text size="sm">
              Futcademic ofrece herramientas para administrar academias deportivas: alumnos,
            ...
            <Text size="sm">
              Futcademic se entrega "tal cual". No nos responsabilizamos por pérdidas derivadas
